...
public class ChucNang2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new ItemData("Trường Sơn Đông Trường Sơn Tây", "Hoàng Hiệp", R.mipmap.ic_launcher));
        list.add(new ItemData("Hò kéo pháo", "Hoàng Vân", R.mipmap.ic_launcher));
        list.add(new ItemData("Chào anh giải phóng quân", "Hoàng Vân", R.mipmap.ic_launcher));
        list.add(new ItemData("Tiếng chày trên sóc Bom Bo", "Xuân Hồng", R.mipmap.ic_launcher));
